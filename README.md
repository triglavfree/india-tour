...
> **Примечание для старых процессоров:** Turbopack отключён в конфигурации, так как он требует BMI2 инструкции. Если возникают ошибки с Turbopack, используйте флаг `--turbopack=false`.
